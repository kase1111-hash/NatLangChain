...
Example
The Asset/Need
What do you have or what do you require?
...
3. Using "Prose Hooks"
Since the Mediators use semantic vectors, specific terminology acts as a "hook" for alignment. Use the precise language of your craft.
For Coders: Mention specific libraries, benchmarks (e.g., "reduced latency by 15ms"), and licensing preferences.
For Writers: Mention tone, word count, and "Right-to-Refuse" clauses for AI training.
For Bounties: State the problem, not just the solution. "I am failing to scale my database past 10k concurrent users" is a better hook than "Need a DB expert."
4. The Constraints (The "No-Go" Zone)
The most powerful way to narrow your alignment is to state what you won't do. This prevents "Bad Alignments" and saves you from the emotional tax of declining deals manually.
Example: "I will not work on projects involving gambling or extractive finance."
Example: "I will not engage in video calls; all mediation must remain on-chain in prose."

5. The "Self-Seeking" Test
Before you post, ask yourself: "If I were a neutral stranger reading this, would I know exactly how to satisfy this person?"
If the answer is "maybe": Your intent is too soft. Add numbers, dates, or specific outcomes.
If the answer is "yes": Post it. The Mediators will do the rest.
